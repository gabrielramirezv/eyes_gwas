...
Se implementó un GWAS para determinar la relación entre 5 SNPs y el color de ojo. Dado que el umbral del p-value se calculó considerando un FDR de 0.05 y que los 5 SNPs vienen de un pool de 500,000, dándonos un resultado de $10^-{7}$, ningún SNP se encontró como significativo. Sin embargo, un SNP,  rs7495174, obtuvo el p-value entre los condidatos, por ello lo consideramos como la asociación con el fenotipo más significativa.  
